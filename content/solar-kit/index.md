...
* **200W solar panel** with standard MC4 connectors. incl. 4 x zip ties to attach to balcony/RV/rooftop/garden structure. Other attachments can be discussed.
* **20ft solar cable** (2 cables - 1x 20ft positive, 20ft negative) with MC4 connectors on both sides.
* **Indoor Grid-tie Micro-inverter** with integrated MPPT 600W Pure Sine inverter with a plug that you can tie straight into your home's outlet.
...
It's a start. It will offset about a 3rd (or 1kW) of your apartments energy consumption per day.
