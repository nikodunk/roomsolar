...
In case of brownouts or **blackouts**, this is be a helpful way of wirelessly charging communications devices without the grid. This 300W, 340Wh system can even keep full-size, 120W refrigerator running for 4 hours to conserve food, or 10 lights running 24 hours.
...
* **Indoor Storage Battery** with integrated MPPT solar charge controller, 340Wh of storage, a 300W Pure Sine inverter with two outputs (alternating current), 3 x USB-A, 1 x USB-C, 1 A/C out (220V, 110V, up to 300W). 3 x DC out, 1 DC solar in.
