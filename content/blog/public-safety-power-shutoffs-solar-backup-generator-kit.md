...
image: /img_cms/neonbrand-unsplash.jpg
type: post
draft: false
---
## The problem
...
If you are in a likely area for power shutoffs, always make sure you have non-perishables stocked up just in case. Canned foods are also a great idea, which is why they are still used in underground bunkers.
...
Last but definitely not least is owning a backup generator, which we’ll get into in the next part.

## How to avoid the food in your fridge spoiling
...
One more apparent con of a traditional backup generator is that they are often way over-powered for what you're trying to run. Ideally, you want a backup generator that can take on all your essential appliances to allow some semblance of everyday living when the power goes out.

Fortunately, Sunboxlabs’ solar backup generator kits will afford you the luxury of power during PSPS’s and run undetected without any noise.

If you do own a backup generator from us, you will know what we're referring to. However, if you don't own one yet, give Sunboxlabs a try to avoid all the unnecessary hiccups.

Let’s take a more in-depth look at our backup solar generators and what they can do.
...
Our 500W medium models can run Wi-Fi, laptops, and phones, plus an LED TV and a mini-fridge. They come with all the same accessories as the small versions, but they feature an extra eight zip ties to help you install the panel.

Don't worry if you need help installing it. Our 1-on-1 zoom call setup session is also available for our medium models. The generators also work anywhere, indoors and out, and can run anything up to 500W.
...
Our most considerable option can run everything above, plus a family fridge to prevent the groceries from spoiling! The large size offers the ability to power any appliance up to 1000W. You get all that’s included with the smaller sizes plus two snap connectors.

Even our larger size is still portable and great for off-grid living, powering vehicles and homes, and for spending time in the outdoors. The large size can support anything from small 8W light bulbs to a full fridge of 200W, a 5000 BTU air conditioner, and an 800W coffee maker.
...
To get our devices to work , you would need to take the solar panel included in your purchase and place it anywhere with direct sunlight. The solar panel will do all the rest and collect energy from the sun that charges your backup battery all day while still providing you with power.

For those who are wondering what happens when the sun sets, you have nothing to worry about. The battery will continue to provide power because it’s been storing it as backup all day.

Our solar backup generators are easy to install without the need for an electrician, permits, or even a screwdriver! They are compatible with any residence, whether it is a house or an apartment.

You won't have to worry about any PSPS's in the future, and our designs are portable. Why rely on the city when you can create your own energy? We have the same reliable lithium battery type you see in Tesla cars, and the best part is the running cost – there is none!

Your purchase is also protected by our money-back guarantee if there are any issues before shipment. We also offer a 1-year limited warranty that pertains to manufacturer defects, and we accept returns for up to 30 days.