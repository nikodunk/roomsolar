    ...
    <section class="recent-posts">            
        <div class="section-title">                
            ...
            <div style="margin: 0 auto; display: flex; flex-wrap: wrap; justify-content: space-around;">
                <img src="/img/AC.jpg" style="max-width: 400px; padding: 10px"> <img src="/img/DISHES.jpg" style="max-width: 400px; padding: 10px">
                Satellite Photo by Paweł Czerwiński |
                Air Conditioner Photo by Chromatograph
            </div>
            <hr>
