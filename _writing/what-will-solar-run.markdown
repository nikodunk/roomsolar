...
![](/assets/img/devices/transportafter.jpg)

A lot of questions we receive here are as to what you can charge with the [$200 solar self sufficiency DIY kit](/assets/blog/200-solar-apartment-system/) and how far the energy will reach. We thought this would be worth a separate, more in-depth analysis.

**Please note that this only applies to the above 100W system, _not_ the new [300, 500 and 1000W kits](/assets/) we sell ourselves. They can run most things**
...
<div style="margin: 0px auto !important; padding: 0px; width: 100% !important">
	<table style="text-align: center; width: 100% !important">
		<tr>
			<td><img src="/assets/img/devices/fridgebefore.jpg" style="max-height: 200px; margin: 0 auto; "></td>
			<td>&rarr;</td>
			<td><img src="/assets/img/devices/fridgeafter.jpg" style="max-height: 200px; margin: 0 auto;"></td>
		</tr>
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/heatbefore.jpg" style="max-height: 200px"></td>
		<td>&rarr;</td>
		<td><img src="/assets/img/devices/heatafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/cookbefore.jpg" style="max-height: 200px"></td>
		<td>&rarr;</td>
		<td><img src="/assets/img/devices/cookafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/coolbefore.jpg" style="max-height: 200px"></td>
		<td>&rarr;</td>
		<td><img src="/assets/img/devices/coolafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/transportbefore.jpg" style="max-height: 200px"></td>
		<td>&rarr;</td>
		<td><img src="/assets/img/devices/transportafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/macbookafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<table style="text-align: center; margin: 0 auto; padding: 0px; width: 100%">
	<tr>
		<td><img src="/assets/img/devices/lightbefore.jpg" style="max-height: 200px"></td>
		<td>&rarr;</td>
		<td><img src="/assets/img/devices/lightafter.jpg" style="max-height: 200px"></td>
	</tr>
	<tr style="padding: 0px; margin: 0px">
...
<script src="/assets//z-na.amazon-adsystem.com/widgets/onejs?MarketPlace=US"></script>
